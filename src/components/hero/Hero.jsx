...
const Hero = () => {
    return (
        <div className='mt-8 flex flex-wrap justify-between max-lg:justify-center'>
            <div className='flex flex-col max-lg:items-center'>
                ...
                <div className='flex max-lg:justify-center gap-5 mt-5 w-full'>
                    <button className='text-white w-full max-w-[177px] h-12 bg-black' type='button'>Hire Me</button>
                    <button className='text-black border-solid border-2 border-zinc-950 w-full max-w-[177px] h-12 bg-white' type='button'>Portfolio</button>
                </div>
            </div>
            <div>
